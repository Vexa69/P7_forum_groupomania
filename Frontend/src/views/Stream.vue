	...
	<main class="container">
		<div class="col-12">
			<div class="col-12 ">
				...
				<h1 v-else class="col-12 my-2 btn  btn-block btn-danger font-weight-bold" style="cursor:default">
				...
				<sub class="col-12 col-md-8">
					<div v-for="message in messages" :key="message.id" class="card bg-light my-3">
						<div class="card-header bg-light d-flex align-items-center justify-content-between m-0 p-1">
							...
							<div class="badge bg-dark text-wrap text-white p-2" style="width: 6rem;">ref # {{ message.id }}</div>
						</div>
