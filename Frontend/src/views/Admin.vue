				...
				<div class="col-12 col-md-4">
					...
					<article class="card bg-light my-3 class=center-block" style="float:none;">
						...
						<div class="card-body mx-auto">
							<button class="btn rounded text-white font-weight-bold" style="background-color: #dd0000;cursor: default">
								Vous avez le pouvoir de supprimer les messages des utilisateurs, leurs commentaires, ainsi que les utilisateurs
								eux-mêmes.
							</button>
						</div>
					</article>
